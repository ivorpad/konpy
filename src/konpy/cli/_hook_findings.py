"""Persisted JSONL findings for verified `konpy hook` fail verdicts."""
...
DEFAULT_FINDINGS_LOG_PATH = ".konpy/hook-findings.jsonl"
...
class HookFinding(BaseModel):
    """A persisted verified fail verdict from `konpy hook`."""
