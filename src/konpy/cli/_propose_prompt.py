"""Prompt construction for `konpy hook-propose`."""

from __future__ import annotations

from collections.abc import Sequence

from konpy.cli._extract_rules_prompt import pack_contract_and_rubric
...
def build_propose_prompt(
    *,
    ...
    return f"""\
You convert recurring konpy hook agentic verification failures into a
...
Never propose or reference a konpy ignore suppression comment; suppressions
