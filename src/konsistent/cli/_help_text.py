"""`help` command registration for the `konsistent` CLI."""
...
def render_help_text() -> str:
    """Render the full `konsistent help` usage text."""
    return f"""konsistent v{__version__} — Enforce structural conventions in Python codebases
